...
from players import RandomPlayer, DEEPQPlayer, PassivePlayer
...
player_2 = RandomPlayer(name="Player")
...
def play_game():
    ...
    while not done:
        ...
        current_player = ai_player if env.current_player == 1 else player_2
...
def evaluate_model(num_games=100):
    ...
    for j in range(num_games):
        ...
        print(f"Game Over! Winner: {winner} {env.stacks[0]} {env.stacks[1]}")
        env.stacks[0] = 20
        env.stacks[1] = 20
...
if __name__ == "__main__":
    evaluate_model(num_games=100)  # Evaluate the model against a RandomPlayer
